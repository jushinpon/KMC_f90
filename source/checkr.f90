...
WRITE(fname,'(a4,i7.7,a4)')'rKMC',nloop,'.dat'

!      open(113,file=fname,status='unknown') !!
open(1213,file='test.dat',status='unknown')
open(1314,file='test2.dat',status='unknown')
write(113,*)'THE TOTAL POSSIBLE REACTIONS: ',nreact	
i=npicked_react
if(ntype(i).eq.1)then
write(113,*)"PICKED REACTION: ",i
write(113,*)ADSORPTION
write(113,*)"At site",nsite(i)
write(113,*)"ADSORBED SPECIES: ",specname(nspec(i))
write(113,*)"SPECIES No.: ",nspec(i)
write(113,*)"RATE CONSTANT: ",react_rate(i)," 1/sec."	    
write(113,*) 
...
write(1213,*)nloop,nloop
write(1213,*)"The system at time of ",Time_go," second"
write(1314,*)nloop,Time_go
write(113,*) 
...
write(1213,*)'*',ntype(npicked_react) &
					,i,specname(ibspecieso(i)), &
                    specname(ibspecies(i))
...
write(113,*)i,specname(ibspecieso(i)),&
         			specname(ibspecies(i))
write(1213,*)'*',ntype(npicked_react),i,specname(ibspecieso(i)),&
	    specname(ibspecies(i))
endif
endif
enddo
